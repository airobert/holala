...
let eqmp_count = ref 0;;
let appthm_count = ref 0;;
let proveHyp_count = ref 0;;
let betaConv_count = ref 0;;
let absThm_count = ref 0;;
let trans_count = ref 0;;
let refl_count = ref 0;;
let deductAntisym_count = ref 0;;
let sym_count = ref 0;;
let assume_count = ref 0;;
let mp_count = ref 0;;
let disch_count = ref 0;;
let gen_count = ref 0;;
